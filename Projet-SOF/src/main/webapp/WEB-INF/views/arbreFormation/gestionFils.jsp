		...
		<tiles:putAttribute name="body">
					...
					<display:column title="Rang">
						<form action="arbreFormation/gestionFilsEditRang.htm" method="post">
							<input hidden="hidden" readonly="false" name="codeEnCours" value="${objEnCours.getCode()}"></input> <input
								hidden="hidden" readonly="false" name="cobject" value="${row.getValue1().getFils().getCode()}"> </input> <input
								type="number" name="rang" value="${row.getValue1().getRang()}" style="width: 3em"> </input>
			...
			<fieldset>
				...
				<div style="margin-bottom: 60px;">
					<form:form class="form-group" action="arbreFormation/sortNLObject.htm?cobject=${objEnCours.getCode()}"
				...
				<form:form action="arbreFormation/addFils.htm?cobject=${objEnCours.getCode()}&amp;typeobject=${param.typeobject}"
					method="post" modelAttribute="selectedFils">
					<div class="form-group">
						<form:label class="col-sm-2 control-label" path="">
