	...
	<tiles:insertDefinition name="master.page">
		...
		<tiles:putAttribute name="body">
			<a class="btn btn-default btn-sm"
				href="arbreFormation/create.htm?context=${param.code}"><spring:message
					code="arbreFormation.creerObj" /></a>
			<a class="btn btn-default btn-sm"
				href="formation/contributeur/edit.htm?cobject=${param.code}"><spring:message
			...
			<display:table name="ObjetNonLie" pagesize="20" class="displaytag"
				...
				<tag:column code="formation.type" property="typeObject.name"
					sortable="true" />
				<tag:column code="formation.mutualisable" property="mutualisable"
					sortable="true" />
				<display:column title="Actions">
					<a class="btn btn-default btn-xs"
